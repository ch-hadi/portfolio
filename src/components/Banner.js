...
export const Banner = () => {
  ...
  const toRotate = ["Web Developer", "MERN  Stack Engineer", "Software Developer"];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Hammad Ahmad`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer", "MERN  Stack Engineer", "Software Developer" ]'><span className="wrap">{text}</span></span></h1>
